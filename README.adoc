...
image:https://img.shields.io/badge/Spring%20Boot-1.2.1-green.svg?style=flat&["Spring Boot", link="http://docs.spring.io/spring-boot/docs/1.2.1.RELEASE/reference/htmlsingle/"]
...
...
dependencies {
  compile "com.domingosuarez.boot:spring-boot-starter-jade4j:0.1.2-SNAPSHOT"
}
...
----
